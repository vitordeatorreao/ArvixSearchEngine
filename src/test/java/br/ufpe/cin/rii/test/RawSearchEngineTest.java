...
public class RawSearchEngineTest
{
	private static final String TEST_FOLDER = "testindex_raw";
	...
	throws Exception
	{
		this.engine = new RawSearchEngine(TEST_FOLDER);
	}
